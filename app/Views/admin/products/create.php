    ...
    <div class="tab-content" id="nav-tabContent">
                ...
                <?php foreach ($languages as $key1 => $val1): ?>
                    ...
                    <div class="tab-pane p-3 fade <?php echo $key1 == 'tr' ? 'show active' : ''; ?>" id="nav-<?php echo $key1; ?>" role="tabpanel" aria-labelledby="nav-<?php echo $key1; ?>-tab">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" value="<?php echo @$request["langs"][$key1]["title"];?>" type="text" id="title" name="langs[<?php echo $key1; ?>][title]" class="form-control" aria-describedby="title">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" type="text" id="info_title" value="<?php echo @$request["langs"][$key1]["info_title"];?>" name="langs[<?php echo $key1; ?>][info_title]" class="form-control" aria-describedby="info_title">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" type="text" id="info_description" value="<?php echo @$request["langs"][$key1]["info_description"];?>" name="langs[<?php echo $key1; ?>][info_description]" class="form-control" aria-describedby="info_description">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" type="text" id="meta_title" value="<?php echo @$request["langs"][$key1]["meta_title"];?>" name="langs[<?php echo $key1; ?>][meta_title]" class="form-control" aria-describedby="meta_title">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" type="text" id="meta_keywords" value="<?php echo @$request["langs"][$key1]["meta_keywords"];?>" name="langs[<?php echo $key1; ?>][meta_keywords]" class="form-control" aria-describedby="meta_keywords">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" type="text" id="meta_description" value="<?php echo @$request["langs"][$key1]["meta_description"];?>" name="langs[<?php echo $key1; ?>][meta_description]" class="form-control" aria-describedby="meta_description">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input form="product-create" type="text" id="slug" value="<?php echo @$request["langs"][$key1]["slug"];?>" name="langs[<?php echo $key1; ?>][slug]" class="form-control" aria-describedby="slug">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <textarea form="product-create" name="langs[<?php echo $key1; ?>][content]" id="content" cols="90%" rows="6"  class="form-control"><?php echo @$request["langs"][$key1]["content"];?></textarea>
                                <script>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <textarea form="product-create" name="langs[<?php echo $key1; ?>][video_embed_code]" id="video_embed_code" cols="90%" rows="4"  class="form-control"><?php echo @$request["langs"][$key1]["video_embed_code"];?></textarea>
                            </div>
                        </div>
        ...
        <div class="tab-pane p-3 fade" id="nav-detaylar" role="tabpanel" aria-labelledby="nav-detaylar-tab">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input form="product-create" type="text" id="product_code" value="<?php echo @$request["product_code"];?>" name="product_code" class="form-control" aria-describedby="prodcut_code">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input form="product-create" type="text" id="quantity" value="<?php echo @$request["quantity"];?>" name="quantity" class="form-control" aria-describedby="quantity">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("basket_discount").value = <?php echo @$request["basket_discount"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("kdv").value = <?php echo @$request["kdv"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <div class="input-group mb-3">
                        <input form="product-create" type="text" id="tl_price" value="<?php echo @$request["tl_price"];?>" name="tl_price" class="form-control" aria-describedby="tl_price">
                        <span class="input-group-text" id="tl_price">₺</span>
                    </div>

                    <div class="input-group mb-3">
                        <input form="product-create" type="text" id="dollar_price" value="<?php echo @$request["dollar_price"];?>" name="dollar_price" class="form-control" aria-describedby="dollar_price">
                        <span class="input-group-text" id="dollar_price">$</span>
                    </div>

                    <div class="input-group mb-3">
                        <input form="product-create" type="text" id="euro_price" value="<?php echo @$request["euro_price"];?>" name="euro_price" class="form-control" aria-describedby="euro_price">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <div class="input-group mb-3">
                        <input form="product-create" type="text" id="second_price" value="<?php echo @$request["second_price"];?>" name="second_price" class="form-control" aria-describedby="second_price">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("out_of_stock").value = <?php echo @$request["out_of_stock"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("status").value = <?php echo @$request["status"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("property_show").value = <?php echo @$request["property_show"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input form="product-create"  type="date" id="product_end_date" value="<?php echo @$request["product_end_date"];?>" name="product_end_date" class="form-control" aria-describedby="product_end_date">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input form="product-create" value="<?php echo @$request["order"] ?? 0;?>" type="text" id="order" name="order" class="form-control" aria-describedby="order">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input form="product-create" value="<?php echo @$request["show_on_homepage"] ?? 0;?>" type="text" id="show_on_homepage" name="show_on_homepage" class="form-control" aria-describedby="show_on_homepage">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("new_product").value = <?php echo @$request["new_product"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    ...
                    <script>document.getElementById("installment").value = <?php echo @$request["installment"];?>;</script>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input form="product-create" value="<?php echo @$request["warranty_period"];?>" type="text" id="warranty_period" name="warranty_period" class="form-control" aria-describedby="warranty_period">
                </div>
            </div>
